    ...
    <div class="header">
      <div class="profile">
        <div class="profile_header">
          ...
          <div class="profile_name">NightObscure</div>
          <div class="profile_open"></div>
        </div>
